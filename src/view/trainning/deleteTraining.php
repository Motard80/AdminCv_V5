...
include_once '../src/controleur/trainning/deleteTrainningCtrl.php';
    ...
    <div class="container text-center">
        <div class="row">
            <div class="col align-self-center">
                <h1>Surptimer la formation  <?= $training->getDescription() ?> </h1>
            </div>
        </div>
        <div class="row"></div>
        <div class="col align-self-center">
            ...
            <form action="" method="post">
                <p> Est vous sur de vouloire supprimer la formation  <?= $training->getDescription() ?>   </p>
